...
This is a rewritten version of Deck.gl's Scatterplot example to
instead load in taxi pick-ups, drop-offs, and visualize how they
correlate with NYC's Business Improvement Districts (BIDs), in 
an effort to see if there is truth to claims of BIDs improving NYC.
